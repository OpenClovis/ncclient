...
class RPC(object):
    ...
    def __init__(self, session, device_handler, asyn=False, timeout=30, raise_mode=RaiseMode.NONE):
        """
    ...
    def __set_async(self, asyn=True):
        self._async = asyn
        if asyn and not self._session.can_pipeline:
